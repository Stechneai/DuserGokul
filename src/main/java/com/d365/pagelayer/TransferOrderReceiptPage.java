...
public class TransferOrderReceiptPage extends MasterClass{
	
	  public TransferOrderReceiptPage()
      {
	  ...
	  @FindBy(xpath = "//span[text()='Invent Transfer Barcode']")
		...
		@FindBy(xpath = "//span[text()='Print Transfer Order']")
		...
		//No of boxes
		//input[contains(@id,'inventtransferorder')and contains(@id,'_InventTransferTable_NoofBoxes_input')]
		@FindBy(xpath = "//input[@name='InventTransferTable_NoofBoxes']")
		private WebElement noofboxes;

		public WebElement txtNoOfBoxes() {
			return noofboxes;
